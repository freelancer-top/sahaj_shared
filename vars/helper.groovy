...
//env.BRANCH_NAME
       bat """ 
       @echo off 
    SonarScanner.MSBuild.exe /k:"Sahaj" /n:"${env.JOB_NAME}" begin /d:sonar.host.url="http://localhost:9000" /d:sonar.branch.name=${BRANCH_NAME} /d:sonar.login="ef87ded16e4176063843cea7f6797fb480cf3183"
